...
<body class="wrapper">
    ...
    <main>
        <form action="<%=request.getContextPath()%>/bulkRegist" method="post" enctype="multipart/form-data" id="bulk_form">
            <h1>一括登録</h1>
            <div class="bulk_form">
                ...
                <c:if test="${!empty errorBulk}">
                    <div class="error">
                        <c:forEach var="errorBulk" items="${errorBulk}">
                    ${errorBulk}
                    </c:forEach>
                    </div>
                </c:if>
